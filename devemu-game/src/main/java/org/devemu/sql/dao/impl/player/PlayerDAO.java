<<<<<<< HEAD:DevemuGame/src/org/devemu/sql/dao/impl/player/PlayerDAO.java
...
public class PlayerDAO implements IPlayerDAO {
    ...
    public PlayerDAO() {
        finders.put("id", new PlayerDAOFinderId());
        finders.put("name", new PlayerDAOFinderName());
        
        loaders.put("id", new PlayerDAOLoaderId());
        loaders.put("name", new PlayerDAOLoaderName());
    }
...
>>>>>>> 800500b6eda7a3b433414a80b9c5ef278d93b04e:devemu-game/src/main/java/org/devemu/sql/dao/impl/player/PlayerDAO.java
