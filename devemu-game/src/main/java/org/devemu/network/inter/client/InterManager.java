...
public class InterManager {
	...
	public static void onConnect(InterClient arg0) {
		...
		loc1.writeString((String)Main.getConfigValue("devemu.service.game.addr"));
		loc1.getData().putInt(Integer.parseInt((String)Main.getConfigValue("devemu.service.game.port")));
